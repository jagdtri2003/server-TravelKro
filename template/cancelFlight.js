...
<body>
  <div class="email-container">
    ...
    <div class="email-content">
      <p class="greeting">Dear ${flightDetails.customerName},</p>
      ...
      <div class="booking-details">
        ...
        <div class="detail-row">
          ...
          <span class="detail-value">${flightDetails.referenceId}</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Flight:</span>
          <span class="detail-value">${flightDetails.flightName} (${flightDetails.flightNumber})</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Route:</span>
          <span class="detail-value">${flightDetails.departureCity} to ${flightDetails.arrivalCity}</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Departure Date:</span>
          <span class="detail-value">${flightDetails.departureDate}</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Passengers:</span>
          <span class="detail-value">${flightDetails.passengerCount}</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Class:</span>
          <span class="detail-value">${flightDetails.cabinClass}</span>
        </div>
                
        <div class="detail-row">
          <span class="detail-label">Cancellation Date:</span>
          <span class="detail-value">${flightDetails.cancellationDate}</span>
        </div>
      </div>
      ...
      <div class="financial-details">
        ...
        <div class="fee-row">
          ...
          <span class="fee-value">₹${flightDetails.totalPrice}</span>
        </div>
        <div class="fee-row">
          <span class="fee-label">Cancellation Fee (15%):</span>
          <span class="fee-value">₹${flightDetails.cancellationFee}</span>
        </div>
        <div class="fee-row refund-row">
          <span class="fee-label">Refund Amount (85%):</span>
          <span class="fee-value">₹${flightDetails.refundAmount}</span>
        </div>
      </div>
      
      <p class="message">Your refund of <strong>₹${flightDetails.refundAmount}</strong> will be processed to your original payment method within 5-7 business days.</p>
